...
from electionguard_tools.scripts.antiverification.processing import add_plaintext_vote, duplicate_election_data, get_share_index_by_id
...
def antiverify_11_a(
    _data: str, contest_id: str, selection_id: str,
) -> None:
    """
